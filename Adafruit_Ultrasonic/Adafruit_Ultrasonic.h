...
#ifndef _ADAFRUIT_SENSOR_ULTRASONIC_
#define _ADAFRUIT_SENSOR_ULTRASONIC_
...
class Adafruit_Ultrasonic : public Adafruit_Sensor {

 public: 
  /* Constructor */
  Adafruit_Ultrasonic(uint8_t,int32_t);
