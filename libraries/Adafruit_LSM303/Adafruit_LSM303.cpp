...
*/
/**************************************************************************/
Adafruit_LSM303_Accel::Adafruit_LSM303_Accel(int32_t sensorID, byte i2cAddress) {
  _sensorID = sensorID;
...
bool Adafruit_LSM303_Accel::begin()
{
  ...
  write8(_i2cAddress, LSM303_REGISTER_ACCEL_CTRL_REG1_A, 0x27);
...
*/
/**************************************************************************/
Adafruit_LSM303_Mag::Adafruit_LSM303_Mag(int32_t sensorID, byte i2cAddress) {
  _sensorID = sensorID;
  _i2cAddress = i2cAddress;
}
